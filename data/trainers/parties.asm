...
FalknerGroup:
	...
	dw HOOTHOOT
	dw BERRY
	dw WING_ATTACK, PROTECT, REFLECT, FAINT_ATTACK
	db 7
	dw PIDGEY
	dw BERRY
	dw STEEL_WING, MUD_SLAP, PURSUIT, WHIRLWIND
	db 7
	dw SPEAROW
	dw BERRY
	dw SUBSTITUTE, PECK, BIDE, QUICK_ATTACK
	db -1 ; end
...
WhitneyGroup:
	...
	db 18
	dw CLEFFA
	dw BELLY_DRUM, MIMIC, PRESENT, METRONOME
	db 18
	dw IGGLYBUFF
	dw DEFENSE_CURL, ROLLOUT, ATTRACT, SHADOW_BALL
	db 18
	dw TOGEPI
	dw ATTRACT, PRESENT, FORESIGHT, CURSE
	db 20
	dw SNUBBULL
	dw CRUNCH, REST, SLEEP_TALK, SNORE
	db -1 ; end
...
BugsyGroup:
	...
	db 14
	dw LEDYBA
	dw LIGHT_SCREEN, REFLECT, BARRIER, SWIFT
	db 14
	dw SPINARAK
	dw SLUDGE_BOMB, BATON_PASS, CURSE, PSYCHIC_M
	db 14
	dw PINECO
	dw PROTECT, PIN_MISSILE, DEFENSE_CURL, ROLLOUT
	db 16
	dw SCYTHER
	dw RAZOR_WIND, SWORDS_DANCE, QUICK_ATTACK, FURY_CUTTER
	db -1 ; end
...
MortyGroup:
	...
	db 5
	dw GASTLY
	dw HYPNOSIS, NIGHTMARE, DREAM_EATER, CURSE
	db 5
	dw GASTLY
	dw MEGA_DRAIN, SHADOW_BALL, PSYCHIC_M, THUNDERBOLT
	db 5
	dw GASTLY
	dw HYPNOSIS, MEAN_LOOK, PERISH_SONG, SWAGGER
	db 5
	dw GASTLY
...
PryceGroup:
	...
	db 31
	dw SHELLDER
	dw REST, SLEEP_TALK, RAPID_SPIN, TOXIC
	db 27
	dw SEEL
	dw REST, HORN_DRILL, SURF, SLEEP_TALK
	db 29
	dw SMOOCHUM
	dw ICE_BEAM, PETAL_DANCE, SLEEP_TALK, REST
	db 31
	dw SWINUB
	dw ICE_BEAM, ROCK_SLIDE, BITE, SWAGGER
	db -1 ; end
...
JasmineGroup:
	...
	db 30
	dw NATU
	dw STEEL_WING, DRILL_PECK, HAZE, SAFEGUARD
	db 35
	dw ONIX
	dw EARTHQUAKE, ROCK_SLIDE, SANDSTORM, IRON_TAIL
	db 30
	dw MAGNEMITE
	dw THUNDERBOLT, HIDDEN_POWER, SUBSTITUTE, THUNDER_WAVE
	db 30
	dw PICHU
	dw IRON_TAIL, RAIN_DANCE, THUNDER, PRESENT
	db -1 ; end
...
ChuckGroup:
	...
	db 30
	dw MACHOP
	dw FIRE_PUNCH, ICE_PUNCH, THUNDERPUNCH, DYNAMICPUNCH
	db 27
	dw MANKEY
	dw REVERSAL, COUNTER, ROCK_SLIDE, MEGA_KICK
	db 27
	dw TYROGUE
	dw RAPID_SPIN, MACH_PUNCH, HIDDEN_POWER, DETECT
	db -1 ; end
...
ClairGroup:
	...
	db 37
	dw DRATINI
	dw THUNDER_WAVE, FLAMETHROWER, SLAM, DRAGONBREATH
	db 37
	dw DRATINI
	...
	db 40
	dw HORSEA
	dw SLEEP_TALK, SURF, REST, DRAGONBREATH
	db 40
	dw MAGIKARP
	dw SPLASH, BUBBLE, REVERSAL, NO_MOVE
	db -1 ; end
...
Rival1Group:
	...
	db 28
	dw MAGNEMITE
	dw TACKLE, THUNDERSHOCK, NO_MOVE, THUNDER_WAVE
	db 30
	dw GASTLY
	dw LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32
	dw HOUNDOUR
	dw LEER, QUICK_ATTACK, BITE, FAINT_ATTACK
	db 32
	dw CHIKORITA
	...
	db 35
	dw MAGNEMITE
	dw THUNDERSHOCK, NO_MOVE, THUNDER_WAVE, SWIFT
	db 35
	dw GASTLY
...
KarenGroup:
	...
	db 44
	dw HOUNDOUR
	dw LEER, ROAR, PURSUIT, FAINT_ATTACK
	db 47
	dw HOUNDOUR
...
ChampionGroup:
	...
	db 46
	dw ZUBAT
	dw WING_ATTACK, BITE, CONFUSE_RAY, SLUDGE_BOMB
	db 46
	dw CHARMANDER
...
MistyGroup:
	...
	db 44
	dw SEEL
	dw SURF, ICE_BEAM, SAFEGUARD, RAIN_DANCE
	db 47
	dw STARYU
...
ScientistGroup:
	...
	db 30
	dw PORYGON
	dw CONVERSION, CURSE, RETURN, PSYCHIC_M
	db -1 ; end
...
YoungsterGroup:
	...
	db 21
	dw RATTATA
	dw TACKLE, CURSE, RETURN, SHADOW_BALL
	db -1 ; end
...
SchoolboyGroup:
	...
	db 35
	dw VOLTORB
	dw TACKLE, CURSE, AGILITY, RETURN
	db 35
	dw GROWLITHE
	dw BITE, CURSE, RETURN, BODY_SLAM
	db 37
	dw ODDISH
	dw ABSORB, SWORDS_DANCE, CURSE, RETURN
	db -1 ; end
	...
	db 35
	dw NATU
	dw LEER, CURSE, RETURN, GIGA_DRAIN
	db 32
	dw ODDISH
	dw SLEEP_POWDER, CURSE, RETURN, GIGA_DRAIN
	db 32
	dw LEDYBA
	dw FORESIGHT, CURSE, RETURN, GIGA_DRAIN
	db 35
	dw WOOPER
	dw TAIL_WHIP, BELLY_DRUM, CURSE, RETURN
	db -1 ; end
	...
	db 34
	dw ABRA
	dw TELEPORT, CURSE, RETURN, PSYCHIC_M
	db 38
	dw MAGNEMITE
	dw TACKLE, CURSE, AGILITY, RETURN
	db -1 ; end
...
BirdKeeperGroup:
	...
	db 40
	dw DODUO
	dw PECK, CURSE, RETURN, QUICK_ATTACK
	db -1 ; end
	...
	db 38
	dw PIDGEY
	dw SAND_ATTACK, CURSE, RETURN, FAINT_ATTACK
	db 38
	dw PIDGEY
	dw SAND_ATTACK, CURSE, RETURN, FAINT_ATTACK
	db -1 ; end
...
LassGroup:
	...
	db 18
	dw SNUBBULL
	dw SCARY_FACE, CURSE, LOVELY_KISS, RETURN
	db -1 ; end
	...
	db 18
	dw MAREEP
	dw GROWL, CURSE, RETURN, BODY_SLAM
	db 18
	dw PSYDUCK
	dw SCRATCH, CURSE, HYPNOSIS, RETURN
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 26
	dw CHARMANDER
	dw GROWL, BELLY_DRUM, CURSE, RETURN
	db 26
	dw SQUIRTLE
	dw TACKLE, CURSE, RETURN, SURF
	db 26
	dw BULBASAUR
	dw GROWL, CURSE, RETURN, GIGA_DRAIN
	db -1 ; end
	...
	db 35
	dw BELLSPROUT
	dw VINE_WHIP, SWORDS_DANCE, CURSE, LOVELY_KISS
	db 35
	dw KRABBY
	dw BUBBLE, CURSE, RETURN, SURF
	db 35
	dw EEVEE
	dw TACKLE, CURSE, RETURN, SHADOW_BALL
	db -1 ; end
	...
	db 27
	dw ELEKID
	dw QUICK_ATTACK, CURSE, RETURN, PSYCHIC_M
	db -1 ; end
	...
	db 33
	dw PARAS
	dw SCRATCH, CURSE, RETURN, GIGA_DRAIN
	db 35
	dw PSYDUCK
	dw SCRATCH, CURSE, HYPNOSIS, RETURN
	db -1 ; end
	...
	db 31
	dw EXEGGCUTE
	dw HYPNOSIS, CURSE, RETURN, GIGA_DRAIN
	db -1 ; end
	...
	db 35
	dw SANDSHREW
	dw SCRATCH, CURSE, RETURN, EARTHQUAKE
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 25
	dw HOPPIP
	dw SPLASH, CURSE, AGILITY, RETURN
	db 25
	dw VULPIX
	dw EMBER, CURSE, HYPNOSIS, RETURN
	db -1 ; end
	...
	db 36
	dw PONYTA
	dw GROWL, CURSE, HYPNOSIS, RETURN
	db -1 ; end
	...
	db 25
	dw CATERPIE
	dw STRING_SHOT, TACKLE, STRING_SHOT, TACKLE
	db 25
	dw ODDISH
	dw ABSORB, SWORDS_DANCE, CURSE, RETURN
	db -1 ; end
	...
	dw STARYU
	dw NO_ITEM
	dw HARDEN, CURSE, RETURN, SURF
	db 40
	dw NIDORAN_F
	dw PINK_BOW
	dw GROWL, CURSE, LOVELY_KISS, RETURN
	db 38
	dw STARYU
	dw NO_ITEM
	dw HARDEN, CURSE, RETURN, SURF
...
PokemaniacGroup:
	...
	db 12
	dw SNUBBULL
	dw SCARY_FACE, BELLY_DRUM, CURSE, RETURN
	db -1 ; end
	...
	db 41
	dw CHANSEY
	dw GROWL, CURSE, RETURN, FIRE_BLAST
	db -1 ; end
...
BugCatcherGroup:
	...
	db 28
	dw VENONAT
	dw DISABLE, CURSE, RETURN, GIGA_DRAIN
	db -1 ; end
	...
	db 25
	dw WEEDLE
	dw POISON_STING, STRING_SHOT, POISON_STING, STRING_SHOT
	db 24
	dw CATERPIE
	dw STRING_SHOT, TACKLE, STRING_SHOT, TACKLE
	db -1 ; end
...
FisherGroup:
	...
	db 25
	dw REMORAID
	dw WATER_GUN, CURSE, RETURN, SURF
	db 25
	dw REMORAID
	dw WATER_GUN, CURSE, RETURN, SURF
	db -1 ; end
	...
	db 34
	dw GOLDEEN
	dw PECK, SWORDS_DANCE, CURSE, RETURN
	db 34
	dw GOLDEEN
	dw PECK, SWORDS_DANCE, CURSE, RETURN
	db 38
	...
	db 35
	dw TENTACOOL
	dw POISON_STING, CURSE, RETURN, DOUBLE_EDGE
	db 39
	dw GOLDEEN
	dw PECK, SWORDS_DANCE, CURSE, RETURN
	db -1 ; end
...
SailorGroup:
	...
	db 38
	dw POLIWAG
	dw BUBBLE, CURSE, LOVELY_KISS, RETURN
	db 38
	dw POLIWAG
	dw BUBBLE, CURSE, LOVELY_KISS, RETURN
	db -1 ; end
...
SuperNerdGroup:
	...
	db 19
	dw SLOWPOKE
	dw CURSE, BELLY_DRUM, RETURN, SURF
	db -1 ; end
...
Rival2Group:
	...
	db 41
	dw MAGNEMITE
	dw THUNDERSHOCK, AGILITY, THUNDER_WAVE, SWIFT
	db 43
	dw GASTLY
	dw MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43
	...
	db 45
	dw MAGNEMITE
	dw THUNDER, NO_MOVE, THUNDER_WAVE, SWIFT
	db 46
	dw GASTLY
	dw MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46
...
HikerGroup:
	...
	db 27
	dw DIGLETT
	dw GROWL, CURSE, RETURN, EARTHQUAKE
	db 27
	dw DIGLETT
	dw GROWL, CURSE, RETURN, EARTHQUAKE
	db -1 ; end
	...
	db 35
	dw SWINUB
	dw TACKLE, CURSE, RETURN, BODY_SLAM
	db 35
	dw DIGLETT
	dw GROWL, CURSE, RETURN, EARTHQUAKE
	db 38
	dw ONIX
	dw SCREECH, CURSE, RETURN, EARTHQUAKE
	db -1 ; end
	...
	db 34
	dw GEODUDE
	dw TACKLE, CURSE, RETURN, FIRE_BLAST
	db 36
	dw GEODUDE
	dw TACKLE, CURSE, RETURN, FIRE_BLAST
	db 34
	dw MACHOP
	dw LEER, CURSE, RETURN, FIRE_BLAST
	db -1 ; end
...
BurglarGroup:
	...
	db 24
	dw KOFFING
	dw POISON_GAS, CURSE, RETURN, FIRE_BLAST
	db -1 ; end
...
BlackbeltGroup:
	...
	db 27
	dw TYROGUE
	dw TACKLE, CURSE, RETURN, MACH_PUNCH
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 33
	dw HOUNDOUR
	dw EMBER, CURSE, RETURN, FIRE_BLAST
	db 33
	dw KOFFING
	dw POISON_GAS, CURSE, RETURN, FIRE_BLAST
	db 35
	...
	db 36
	dw ZUBAT
	dw LEECH_LIFE, CURSE, RETURN, GIGA_DRAIN
	db -1 ; end
...
PsychicGroup:
	...
	db 17
	dw DROWZEE
	dw HYPNOSIS, CURSE, RETURN, PSYCHIC_M
	db -1 ; end
...
PicnickerGroup:
	...
	db 31
	dw CLEFFA
	dw CHARM, BELLY_DRUM, CURSE, RETURN
	db -1 ; end
	...
	db 32
	dw NIDORAN_M
	dw LEER, CURSE, LOVELY_KISS, RETURN
	db 32
	dw NIDORAN_F
	dw GROWL, CURSE, LOVELY_KISS, RETURN
	db -1 ; end
...
CamperGroup:
	...
	db 36
	dw SLUGMA
	dw SMOG, CURSE, RETURN, FIRE_BLAST
	db 34
	dw PSYDUCK
	dw SCRATCH, CURSE, HYPNOSIS, RETURN
	db -1 ; end
...
ExecutiveFGroup:
	...
	db 32
	dw HOUNDOUR
	dw LEER, CURSE, RETURN, SHADOW_BALL
	db -1 ; end
...
TwinsGroup:
	...
	db 16
	dw IGGLYBUFF
	dw CHARM, CURSE, PERISH_SONG, RETURN
	db -1 ; end
...
MysticalmanGroup:
	...
	db 23
	dw GASTLY
	dw HYPNOSIS, CURSE, PERISH_SONG, RETURN
	db 25
	dw VOLTORB
	dw TACKLE, CURSE, AGILITY, RETURN
	db -1 ; end
