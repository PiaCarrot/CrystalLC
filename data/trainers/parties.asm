...
SchoolboyGroup:
	...
	db 35
	dw VOLTORB
	dw SCREECH, NO_MOVE, ROLLOUT, LIGHT_SCREEN
	db 35
	dw GROWLITHE
	...
	db 32
	dw YANMA
	dw QUICK_ATTACK, DOUBLE_TEAM, NO_MOVE, SUPERSONIC
	db 35
	dw WOOPER
...
SwimmerFGroup:
	...
	db 21
	dw HORSEA
	dw NO_MOVE, SMOKESCREEN, LEER, WATER_GUN
	db -1 ; end
...
MysticalmanGroup:
	...
	db 25
	dw VOLTORB
	dw SCREECH, NO_MOVE, THUNDER, ROLLOUT
	db -1 ; end
