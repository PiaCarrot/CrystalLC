...
RockTunnel1FHiddenZinc:
	hiddenitem ZINC, EVENT_ROCK_TUNNEL_1F_HIDDEN_ZINC

RockTunnel1FHiddenZinc2:
	hiddenitem ZINC, EVENT_ROCK_TUNNEL_1F_HIDDEN_ZINC_2
...
RockTunnel1F_MapEvents:
	...
	def_bg_events
	bg_event 24,  4, BGEVENT_ITEM, RockTunnel1FHiddenZinc
	bg_event 21, 15, BGEVENT_ITEM, RockTunnel1FHiddenZinc2
