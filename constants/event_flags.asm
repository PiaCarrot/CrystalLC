...
; Johto story events
	...
	const EVENT_GOT_FOSSIL_POKEMON_FROM_OAKS_LAB
...
; Johto hidden items
	...
	const EVENT_SILVER_CAVE_ROOM_1_HIDDEN_PP_UP
...
; Kanto hidden items
	...
	const EVENT_UNDERGROUND_PATH_HIDDEN_ZINC
	const EVENT_ROCK_TUNNEL_1F_HIDDEN_ZINC
	const EVENT_ROCK_TUNNEL_1F_HIDDEN_ZINC_2
...
; Johto itemballs
	...
	const EVENT_SPROUT_TOWER_2F_ZINC
...
; New to Crystal
	...
	const EVENT_DARK_CAVE_VIOLET_ENTRANCE_PP_UP
